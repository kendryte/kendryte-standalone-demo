    ...
    size_t data_size)
{
    ...
    if (cipher_mod == AES_CBC)
    {
        ...
        aes_cbc192_hard_encrypt_dma(DMAC_CHANNEL0, DMAC_CHANNEL1, &cbc_context, aes_data, data_size, aes_hard_out_data);
        if(get_time_flag)
    ...
    else if (cipher_mod == AES_ECB)
    {
        ...
        aes_ecb192_hard_encrypt_dma(DMAC_CHANNEL0, DMAC_CHANNEL1, input_key, aes_data, data_size, aes_hard_out_data);
        if(get_time_flag)
    ...
    else
    {
        ...
        aes_gcm192_hard_encrypt_dma(DMAC_CHANNEL0, DMAC_CHANNEL1, &gcm_context, aes_data, data_size, aes_hard_out_data, gcm_hard_tag);
        if(get_time_flag)
    ...
    size_t data_size)
{
    ...
    if (cipher_mod == AES_CBC)
        aes_cbc192_hard_decrypt_dma(DMAC_CHANNEL0, DMAC_CHANNEL1, &cbc_context, aes_hard_out_data, padding_len, aes_soft_out_data);
    else if (cipher_mod == AES_ECB)
        aes_ecb192_hard_decrypt_dma(DMAC_CHANNEL0, DMAC_CHANNEL1, input_key, aes_hard_out_data, padding_len, aes_soft_out_data);
    else
        aes_gcm192_hard_decrypt_dma(DMAC_CHANNEL0, DMAC_CHANNEL1, &gcm_context, aes_hard_out_data, padding_len, aes_soft_out_data, gcm_hard_tag);
    check_tag = 0;
